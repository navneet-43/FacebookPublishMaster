    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-75 z-20">
      <div className="fixed inset-y-0 left-0 max-w-xs w-full bg-white shadow-xl">
        ...
        <nav className="mt-4">
          ...
          <Link href="/fb-video-download" onClick={onClose} className={`flex items-center px-4 py-3 ${isActive('/fb-video-download') ? 'text-fb-blue bg-fb-light-gray border-l-4 border-fb-blue' : 'text-gray-600 hover:bg-fb-light-gray'}`}>
